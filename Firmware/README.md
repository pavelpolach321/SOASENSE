Currently, WIFI is used as a wireless protocol for transferring data.

This repository also contains lorawan based code for LMIC-node, an example LoRaWAN application for a node for The Things Network.

In future versions both protocol will be implemented.

Following text is related to LMIC-Node project, which was forked here
